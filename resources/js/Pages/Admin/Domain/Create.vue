...
<template>
    <Admin>
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-1">
            <form @submit.prevent="form.post(route('admin.domains.store'))" class="pb-10">
                <div class="mb-5">
                    <label class="block mb-2 text-sm font-medium text-green-700" for="domain-success">Domain</label>
                    <input v-model="form.domain" id="domain"
